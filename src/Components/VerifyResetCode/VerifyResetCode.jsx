    ...
    <>
      ...
      >
        <div className="w-full flex items-start flex-col justify-start mb-3 ">
          <label
            htmlFor="resetCode"
            className=" text-main font-bold text-3xl dark:text-white-200 mr-2 my-3 capitalize"
          >
          ...
          <input
            ...
            id="resetCode"
            name="resetCode"
            className="w-full px-3 dark:text-white-200 dark:bg-green-900 py-2 rounded-md border border-main dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-main"
        ...
        <div className="mb-4">
          ...
          <p className="text-white-700 dark:text-white-200 font-bold">
            Time left: {formatTime(timeLeft)}
          </p>
        </div>
        <button
          type="submit"
          className="bg-main hover:bg-sec hover:text-main text-white font-medium py-2 px-4 rounded-md shadow-sm disabled:bg-green-500 disabled:cursor-not-allowed disabled:hover:text-white"
