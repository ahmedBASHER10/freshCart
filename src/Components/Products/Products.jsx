        ...
        <div>
          <div className="max-w-xl mx-auto mb-7 px-2 sm:px-0">
            <label
              ...
              className="mb-2 text-sm font-medium text-white-900 sr-only dark:text-white-300"
            >
              Search
            </label>
            <div className="relative">
              ...
              <input
                ...
                type="search"
                id="default-search"
                className="block p-4 pl-10 w-full text-sm text-white-900 bg-green-50 rounded-lg border border-gray-300 focus:ring-main focus:border-main focus:outline-none dark:bg-green-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-main dark:focus:border-main"
