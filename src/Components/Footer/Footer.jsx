  ...
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 ">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
      ...
      <Link to={""} className="text-3xl font-bold text-main ">
        ...
        <p className="max-w-xs mt-4 text-sm text-white-600 dark:text-white-400">
      ...
      <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-white-500 dark:text-white-400">
    ...
    <p className="mt-8 text-xs text-white-800 dark:text-white-400">
      © 2024 Comany Name
    </p>
  </div>
</footer>
