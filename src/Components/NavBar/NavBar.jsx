...
export default function NavBar() {
  ...
  return (
    <>
      <div className="fixed flex items-center justify-between py-3 px-8 bg-white dark:bg-green-800 shadow-md w-full overflow-hidden z-[990] top-0">
        ...
        <div>
          <ul className="hidden xl:flex space-x-3 justify-center items-center">
            ...
            <li>
              ...
              >
                {darkMode ? (
                  <i className="fa-solid fa-moon  hover:bg-green-300 px-2 py-1 rounded text-xl"></i>
                ) : (
                  <i className="fa-solid fa-sun hover:bg-green-100 px-2 py-1 rounded text-xl"></i>
                )}
              </button>
            </li>
          </ul>
        ...
        <div className="xl:hidden">
          ...
          >
            <svg
              className="w-7 h-6 text-white-700 dark:text-white"
              fill="none"
              strokeLinecap="round"
      ...
      <div
        className={
          isOpen
            ? "mobile-menu bg-[#F4D9D0] dark:bg-green-700 mt-14 p-1 xl:hidden z-50 fixed w-full top-0 "
      ...
      >
        <ul className="space-y-4 text-center">
          ...
          <li className="w-7 dark:text-white-400 hover:bg-green-200 p-1 rounded-lg text-lg mx-auto">
