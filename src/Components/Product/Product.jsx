  ...
  return (
    <>
      <div className="productCard max-w-lg  h-full overflow-y-hidden p-2  ">
        <div className="bg-white hover:shadow-3xl hover:shadow-main rounded-lg max-w-sm dark:bg-green-800 dark:border-gray-700 h-full">
          ...
          <div className="px-3 py-1 pb-5">
            <div className=" flex justify-between items-center">
              <Link to={"/productDetails/" + product._id}>
                <h3 className="text-white-900 font-semibold text-xl tracking-tight dark:text-white line-clamp-1">
                  {product.title}
                </h3>
              </Link>
              <i
                className={`fa-solid fa-heart text-3xl  ${
                  isActive ? "text-main" : "text-white-400"
                }`}
