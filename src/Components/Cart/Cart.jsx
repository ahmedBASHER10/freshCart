  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <div className="bg-green-100 h-auto py-8 dark:bg-Dark">
        ...
        <div className="text-4xl font-bold text-center bg-green-100 rounded-md py-12 dark:text-black dark:bg-green-200">
