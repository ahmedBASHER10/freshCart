...
export default function RelatedProducts({ relatedProducts }) {
  ...
  return (
    <>
      <div className="mt-16">
        <h3 className="text-white-600 text-2xl font-medium mb-2 dark:text-white-400">
          More Products
        </h3>
        <Slider {...settings}>
                ...
                <div className=" shadow-md ">
                  ...
                  <div className="px-5 py-3">
                    <Link to={"/productDetails/" + product.id}>
                      {" "}
                      <h3 className="text-white-700 line-clamp-1 hover:text-main dark:text-white-400 dark:hover:text-main mb-1">
                        {product.title}
                      </h3>
                    </Link>
                    <span className="text-black mt-2 dark:text-white-400 "><sup className="font-normal text-base ">EGP</sup>{formatNumber(product.price)}</span>
                  </div>
                </div>
              </div>
            );
