...
export default function Home() {
  ...
  // A ref to track the first render
  useEffect(() => {
    getAllCategories();
  ...
  <div className="hidden xl:block xl:w-1/4 h-full   z-10">
    ...
    <img src={img5} className="w-full h-1/2 object-cover rounded-br-md lg:rounded-br-none " alt="" />
        ...
        <div class="max-w-2xl mx-auto mb-7 mt-7 px-2 sm:px-0">
          <label
            for="default-search"
            class="mb-2 text-sm font-medium text-white-900 sr-only dark:text-white-300"
          >
            Search
          </label>
          <div class="relative">
            ...
            <input
              ...
              type="search"
              id="default-search"
              class="block p-4 pl-10 w-full text-sm text-white-900 bg-green-50 rounded-lg border border-gray-300 focus:ring-main focus:border-main focus:outline-none dark:bg-green-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-main dark:focus:border-main"
    ...
    {pageNumbers.map((number) => (
      <button
        ...
        className={`px-4 py-2 rounded-lg transition-colors duration-300 
          ${currentPage === number ? "bg-main text-white" : "bg-green-200 text-white-900 "} 
          `}
      >
        {number}
      </button>
