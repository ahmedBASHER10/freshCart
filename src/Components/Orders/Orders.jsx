        ...
        return (
          <div key={index} className="my-5 px-3 sm:px-0">
            <div class="flex justify-start item-start space-y-2 flex-col">
              <h1 class="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-white-800">
                Order #{order.id}
              </h1>
              <p class="text-base dark:text-white-300 font-medium leading-6 text-white-600">
            ...
            <div class="mt-10 flex flex-col  jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
              <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                <div class=" flex flex-col justify-start items-start rounded-md dark:bg-green-800 bg-green-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                  <p class="text-lg md:text-xl dark:text-white font-semibold leading-6 xl:leading-5 text-white-800">
                    Customer’s Cart
                  </p>
                      ...
                      <div class=" md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                        <div class="w-full flex flex-col justify-start items-start space-y-8">
                          ...
                          <div class="flex justify-start items-start flex-col space-y-2">
                            <p class="text-sm dark:text-white leading-none text-white-800">
                              <span class="dark:text-white-400 text-white-300">
                                Style:
                              </span>
                              {item.product.title}
                            </p>
                        ...
                        <div class="flex justify-between space-x-8 items-start w-full">
                          ...
                          {item.count < 10 ? (
                            <p class="text-base dark:text-white xl:text-lg leading-6 text-white-800">
                              0{item.count}
                            </p>
                          ) : (
                            <p class="text-base dark:text-white xl:text-lg leading-6 text-white-800">
                          ...
                          <p class="text-base dark:text-white xl:text-lg font-semibold leading-6 text-white-800">
                ...
                <div class="flex justify-center flex-col md:flex-row  items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                  <div class="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-green-50 dark:bg-green-800 space-y-6">
                    <h3 class="text-xl dark:text-white font-semibold leading-5 text-white-800">
                      Summary
                    </h3>
                    <div class="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                      <div class="flex justify-between w-full">
                        <p class="text-base dark:text-white leading-4 text-white-800">
                          Subtotal
                        </p>
                        <p class="text-base dark:text-white-300 leading-4 text-white-600">
                    ...
                    <div class="flex justify-between items-center w-full">
                      <p class="text-base dark:text-white font-semibold leading-4 text-white-800">
                        Total
                      </p>
                      <p class="text-base dark:text-white-300 font-semibold leading-4 text-white-600">
                      <sup className="font-normal text-base ">EGP</sup>{formatNumber(order.totalOrderPrice)}
                      </p>
                    </div>
                  </div>
                  <div class="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-green-50 dark:bg-green-800 space-y-6">
                    <h3 class="text-xl dark:text-white font-semibold leading-5 text-white-800">
                      Details
                    </h3>
                    <div class="flex flex-col justify-start  w-full">
                      <p class="text-lg leading-6 dark:text-white font-semibold text-white-800">
